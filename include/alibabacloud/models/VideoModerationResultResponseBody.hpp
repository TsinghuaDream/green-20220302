...
namespace Models
{
  ...
  public:
    ...
    inline const VideoModerationResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, VideoModerationResultResponseBodyData) };
    inline VideoModerationResultResponseBodyData data() { DARABONBA_PTR_GET(data_, VideoModerationResultResponseBodyData) };
    inline VideoModerationResultResponseBody& setData(const VideoModerationResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline VideoModerationResultResponseBody& setData(VideoModerationResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<VideoModerationResultResponseBodyData> data_ = nullptr;
